...
import uk.gov.hmrc.apiplatform.modules.events.applications.domain.models.ResponsibleIndividualDeclinedOrDidNotVerify
...
object ResponsibleIndividualDeclinedOrDidNotVerifyNotification {
  ...
  def sendAdviceEmail(
    ...
    emailConnector.sendResponsibleIndividualDeclinedOrDidNotVerify(
