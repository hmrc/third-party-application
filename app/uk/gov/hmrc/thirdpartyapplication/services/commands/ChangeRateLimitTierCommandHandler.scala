...
class ChangeRateLimitTierCommandHandler @Inject() (
  ...
  private def asEvents(app: ApplicationData, cmd: ApplicationCommands.ChangeRateLimitTier): NonEmptyList[ApplicationEvent] = {
    NonEmptyList.of(
  ...
  def process(app: ApplicationData, cmd: ApplicationCommands.ChangeRateLimitTier)(implicit hc: HeaderCarrier): AppCmdResultT = {
