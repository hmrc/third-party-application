...
import uk.gov.hmrc.apiplatform.modules.commands.applications.domain.models.{ApplicationCommands, NameDescriptionCommand}
import uk.gov.hmrc.thirdpartyapplication.models.db.StoredApplication
import uk.gov.hmrc.thirdpartyapplication.services.commands.CommandHandler

@Singleton
class NameDescriptionCommandsProcessor @Inject() (
    changeProductionApplicationNameCommandHandler: ChangeProductionApplicationNameCommandHandler,
  ...
  def process(app: StoredApplication, command: NameDescriptionCommand): AppCmdResultT = command match {
    case cmd: ChangeProductionApplicationName     => changeProductionApplicationNameCommandHandler.process(app, cmd)
