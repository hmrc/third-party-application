...
import uk.gov.hmrc.apiplatform.modules.commands.applications.domain.models.{ApplicationCommands, ClientSecretCommand}
import uk.gov.hmrc.thirdpartyapplication.models.db.StoredApplication
import uk.gov.hmrc.thirdpartyapplication.services.commands.CommandHandler

@Singleton
class ClientSecretCommandsProcessor @Inject() (
  ...
  def process(app: StoredApplication, command: ClientSecretCommand): AppCmdResultT = command match {
