...
object AppDependencies {
  ...
  lazy val applicationEventVersion  = "0.90.0" // Ensure this version of the application-events library uses the appDomainVersion below
  lazy val applicationDomainVersion = "0.94.0"
