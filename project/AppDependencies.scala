...
object AppDependencies {
  ...
  lazy val applicationEventVersion  = "0.83.0-SNAPSHOT" // Ensure this version of the application-events library uses the appDomainVersion below
  lazy val applicationDomainVersion = "0.82.0-SNAPSHOT"
