...
import uk.gov.hmrc.controllers.{OverridesRequest, OverridesResponse, ScopeRequest, ScopeResponse}
import uk.gov.hmrc.http.HeaderCarrier
import uk.gov.hmrc.models._
import uk.gov.hmrc.play.audit.http.connector.AuditResult
import uk.gov.hmrc.play.test.UnitSpec
import uk.gov.hmrc.repository.ApplicationRepository
import uk.gov.hmrc.services.AuditAction.{OverrideAdded, OverrideRemoved, ScopeAdded, ScopeRemoved}
import uk.gov.hmrc.services.{AccessService, AuditAction, AuditService}
