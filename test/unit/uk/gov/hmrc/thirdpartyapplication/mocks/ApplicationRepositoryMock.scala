...
trait ApplicationRepositoryMock extends MockitoSugar with ArgumentMatchersSugar {

  object ApplicationRepoMock {
    ...
    object FetchByClientId {
      def thenReturn(clientId: String)(applicationData: ApplicationData) =
