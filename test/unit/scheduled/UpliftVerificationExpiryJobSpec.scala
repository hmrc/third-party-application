...
import uk.gov.hmrc.models.State.PENDING_REQUESTER_VERIFICATION
import uk.gov.hmrc.models._
import uk.gov.hmrc.mongo.{MongoConnector, MongoSpecSupport}
import uk.gov.hmrc.play.test.UnitSpec
import uk.gov.hmrc.repository.{ApplicationRepository, StateHistoryRepository}
import uk.gov.hmrc.scheduled.{JobConfig, UpliftVerificationExpiryJob, UpliftVerificationExpiryJobLockKeeper}
