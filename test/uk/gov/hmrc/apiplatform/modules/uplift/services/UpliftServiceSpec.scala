...
//       // val qry = ApplicationQueries.applicationsByVerifiableUplify(appStateVerificationCode)

//       ApplicationRepoMock.FetchByGeneralOpenEndedApplicationQuery.thenReturnsWhen(???, application)
