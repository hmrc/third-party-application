...
trait ApplicationUpliftMockModule extends MockitoSugar with ArgumentMatchersSugar {
    
  protected trait BaseApplicationUpliftMock {
  ...
  object ApplicationUpliftMock extends BaseApplicationUpliftMock {
